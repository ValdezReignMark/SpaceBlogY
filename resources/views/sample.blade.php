...
<body onload="startTime()" class="w3-white">

<!-- Navigation bar with social media icons -->
<div class="w3-bar w3-black w3-transparent w3-hide-small">

<i class="material-icon w3-icon-lg fa fa-home "></i>
...
<!--sub Header -->
<div class="w3-container w3-center" id="dropdowncontainer">
...
<div>
  ...
  <a href="#"><img style="width:10%" src="/images/logonotag.png" class="img-fluid w3-bar-item  w3-center " alt="logonotag"> </a>
